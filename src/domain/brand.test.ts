...
describe('brand system', () => {
  it('creates brand, release and finishes campaign', () => {
    ...
    const draft: ReleaseDraft = { brandId: first.brand.id, batchId: batch.id, name: 'Black Field', positioning: 'premium', packaging: { form: 'longneck', glass: 'black', label: 'minimal', closure: 'crown', volumeMl: 500, carton: true }, wholesalePrice: 3, retailPrice: 5.5 };
