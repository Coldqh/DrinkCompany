...
export const primaryProcessors: PrimaryProcessorDefinition[] = [
  ...
  { id: 'processor-ferment-beer', organizationId: 'org-supplier-ferment-lab', assetId: 'asset-supplier-ferment-lab', kind: 'culture_lab', inputCommodityId: 'raw-sugar-beet', capacityPerDay: 80, minimumInput: 20, processingCostPerInput: .75, outputs: [{ ingredientId: 'beer-yeast', share: .52, yieldPerInput: .18, qualityModifier: 8 }, { ingredientId: 'cider-yeast', share: .48, yieldPerInput: .18, qualityModifier: 8 }] },
];
